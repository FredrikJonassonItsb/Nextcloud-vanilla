OC.L10N.register(
    "spreed",
    {
    "View verified identity (moderator only)" : "Visa identitet",
    "No additional info for this attendee" : "Finns ingen ytterligare info om mötesdeltagare",
    "Guest: {firstName} {lastName} (SSN: {ssn})" : "Mötesdeltagare: {firstName} {lastName} (PNR: {ssn})",
    "Sign out and exit call" : "Logga ut och lämna samtal",
    "Guest" : "Gäst",
