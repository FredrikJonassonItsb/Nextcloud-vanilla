...
use OCA\SdkMc\Event\PublishInitialStateEventForGuests; // itsl change
...
class PageController extends Controller {
	...
	protected function guestEnterRoom(
		...
		$this->publishInitialStateForGuest();
		$this->eventDispatcher->dispatchTyped(new PublishInitialStateEventForGuests($this->initialState)); // itsl change
		$this->eventDispatcher->dispatchTyped(new RenderReferenceEvent());
