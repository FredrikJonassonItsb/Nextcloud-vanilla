...
class RoomService {
	...
	public function createConversation(
		...
		// Apply admin-configured default lobby state for group/public rooms
		if ($lobbyState === Webinary::LOBBY_NONE
			&& in_array($type, [Room::TYPE_GROUP, Room::TYPE_PUBLIC], true)) {
			$lobbyState = $this->config->getDefaultLobbyState();
		}
