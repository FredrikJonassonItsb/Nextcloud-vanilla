...
class Config {
	...
	/**
	 * Returns the admin-configured default lobby state.
	 *
	 * @return int
	 */
	public function getDefaultLobbyState(): int {
		return match ((int)$this->config->getAppValue('spreed', 'default_lobby_state', (string)Webinary::LOBBY_NONE)) {
			Webinary::LOBBY_NON_MODERATORS => Webinary::LOBBY_NON_MODERATORS,
			default => Webinary::LOBBY_NONE,
		};
	}
}
