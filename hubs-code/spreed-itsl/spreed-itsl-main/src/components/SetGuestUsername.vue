...
<template>
	<div class="username-form">
		...
		<!-- itsl change start -->
		<a class="sign-out-guest" @click="logout">
			{{ t('spreed', 'Sign out and exit call') }}
		</a>
		<!-- itsl change end -->
...
import axios from '@nextcloud/axios' // itsl change
import { showSuccess } from '@nextcloud/dialogs' // itsl change
...
export default {
	...
	methods: {
		...
		// start itsl change
		async logout() {
			const logoutUrl = generateUrl('/apps/sdkmc/spreed/guest/logout/{token}', { token: this.token })
