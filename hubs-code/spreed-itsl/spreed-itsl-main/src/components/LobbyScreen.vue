...
import { useGuestNameStore } from '../stores/guestName.js' // itsl change
...
export default {
	...
	async mounted() {
		if (this.currentUserIsGuest) {
			...
			console.debug("CURRENT USER IS GUEST, SETTING guest name from LOBBY SCREEN", participantData)
			const guestNameStore = useGuestNameStore()
			await guestNameStore.submitGuestUsername(this.token, participantData)
		}
	},
