OC.L10N.register(
    "mail",
    {
    "Could not mark as read" : "Could not mark as read",
    "Could not mark as unread" : "Could not mark as unread",
    "Embedded message %s" : "Embedded message %s",
    "Mail" : "Secure Digital Communication",
    "💌 A mail app for Nextcloud" : "Secure Digital Communication",
    "**Säker Digital Kommunikation (ITSL Hubs)**\n\nA secure communication platform for the Swedish public sector.\n\n- **Multiple channels** – SDK, Secure Email, internal messages, SMS, and FAX\n- **Secure by design** – all communication handled through secure channels\n- **Integration** – connects to your organization's existing systems\n- **Built on Nextcloud Mail** – ITSL-customized build of the upstream Nextcloud Mail app, with SDK messaging, tagging, assignment, FAX, and audit logging for Swedish public-sector workflows" : "**Säker Digital Kommunikation (ITSL Hubs)**\n\nA secure communication platform for the Swedish public sector.\n\n- **Multiple channels** – SDK, Secure Email, internal messages, SMS, and FAX\n- **Secure by design** – all communication handled through secure channels\n- **Integration** – connects to your organization's existing systems\n- **Built on Nextcloud Mail** – ITSL-customized build of the upstream Nextcloud Mail app, with SDK messaging, tagging, assignment, FAX, and audit logging for Swedish public-sector workflows\n",
    "Important mail" : "Important messages",
    "No message found yet" : "No message found yet",
    "Set up an account" : "Set up an account",
    "Unread mail" : "Unread messages",
    "Important" : "Set High Priority",
    "Work" : "Work",
    "Personal" : "Personal",
    "To Do" : "To Do",
    "Later" : "Later",
    "You are reaching your mailbox quota limit for {account_email}" : "You are reaching your storage quota limit for {account_email}",
    "You are currently using {percentage} of your mailbox storage. Please make some space by deleting unneeded emails." : "You are currently using {percentage} of your storage. Please make some space by deleting unneeded messages.",
    "Mail Application" : "Secure Digital Communication",
    "Mails" : "Messages",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following email: %3$s" : "Sender address: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following address: %3$s",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following emails: %3$s" : "Sender address: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following addresses: %3$s",
    "Sender is using a custom email: %1$s instead of the sender email: %2$s" : "Sender is using a custom address: %1$s instead of the sender address: %2$s",
    ...
    "Mail Transport configuration" : "Transport configuration",
    ...
    "Archived messages are moved in:" : "Processed messages are moved to:",
    ...
    "Please enter an email of the format name@example.com" : "Please enter an address in the format name@example.com",
    "Password" : "Password",
    ...
    "Checking mail host connectivity" : "Checking server connectivity",
    ...
    "The folders to use for drafts, sent messages, deleted messages, archived messages and junk messages." : "The folders to use for drafts, sent messages, deleted messages, processed messages and junk messages.",
    ...
    "Sort favorites up" : "Sort favorites up",
    "When on, favorite messages will be sorted to the top of folders" : "When on, favorite messages will be sorted to the top of folders",
    "Layout" : "Layout",
    ...
    "Archive thread" : "Mark as processed",
    ...
    "Could not archive message" : "Could not mark message as processed",
    ...
    "Add internal email or domain" : "Add internal address or domain",
    ...
    "You are not allowed to move this message to the archive folder and/or delete this message from the current folder" : "You are not allowed to move this message to the processed messages folder and/or delete this message from the current folder",
    ...
    "No more submailboxes in here" : "No more subfolders here",
    "Favorites" : "Favorites",
    ...
    "The account for {email} and cached email data will be removed from Nextcloud, but not from your email provider." : "You will be disconnected from the mailbox {email}. The mailbox and its messages remain available to other users.",
    ...
    "Loading …" : "Loading …",
    "All messages in mailbox will be deleted." : "All messages in this folder will be deleted.",
    "Clear mailbox {name}" : "Clear folder {name}",
    ...
    "An error occurred, unable to rename the mailbox." : "An error occurred, unable to rename the folder.",
    ...
    "Welcome to {productName} Mail" : "Welcome to {productName} Secure Digital Communication",
    ...
    "Mail server error" : "Server error",
    "Message could not be sent" : "Message could not be sent",
    "Message deleted" : "Message deleted",
    "Phishing email" : "Phishing message",
    "This email might be a phishing attempt" : "This message might be a phishing attempt",
    ...
    "Add" : "Add",
    "Copied email address to clipboard" : "Copied address to clipboard",
    "Could not copy email address to clipboard" : "Could not copy address to clipboard",
    "Show less" : "Show less",
    "Show more" : "Show more",
    ...
    "Send unsubscribe email" : "Send unsubscribe request",
    "Unsubscribe via email" : "Unsubscribe via message",
    ...
    "Disable trash retention by leaving the field empty or setting it to 0. Only mails deleted after enabling trash retention will be processed." : "Disable trash retention by leaving the field empty or setting it to 0. Only messages deleted after enabling trash retention will be processed.",
    ...
    "Sender" : "Sender",
    "Recipient" : "Recipient",
    "Delete mail filter {filterName}?" : "Delete filter {filterName}?",
    "Are you sure to delete the mail filter?" : "Are you sure you want to delete the filter?",
    "Delete filter" : "Delete filter",
    "New filter" : "New filter",
    "Filter saved" : "Filter saved",
    "Could not save filter" : "Could not save filter",
    "Take control of your email chaos. Filters help you to prioritize what matters and eliminate clutter." : "Filters help you to prioritize what matters and eliminate clutter.",
    ...
    "Mail app" : "Secure messaging",
    "The mail app allows users to read mails on their IMAP accounts." : "The app allows users to read messages in their mailboxes.",
    ...
    "A provisioning configuration will provision all accounts with a matching email address." : "A provisioning configuration will provision all mailboxes with a matching address.",
    ...
    "This setting only makes most sense if you use the same user back-end for your Nextcloud and mail server of your organization." : "This setting only makes sense if you use the same user back-end for your system and server.",
    ...
    "Allow additional mail accounts" : "Allow additional mailboxes",
    "Allow additional Mail accounts from User Settings" : "Allow additional mailboxes from User Settings",
    "Enable text processing through LLMs" : "Enable text processing through LLMs",
    "The Mail app can process user data with the help of the configured large language model and provide assistance features like thread summaries, smart replies and event agendas." : "The app can process user data with the help of the configured large language model and provide assistance features like thread summaries, smart replies and event agendas.",
    ...
    "The Mail app can use AI and machine learning to classify, summarize, and analyze emails. When disabled, no AI/ML processing will run for any user. When enabled, individual users can toggle importance classification for their accounts." : "The Mail app can use AI and machine learning to classify, summarize, and analyze emails. When disabled, no AI/ML processing will run for any user. When enabled, individual users can toggle importance classification for their accounts.",
    "Enable classification of important mails by default" : "Enable classification of important messages by default",
    "Anti Spam Service" : "Anti Spam Service",
    "You can set up an anti spam service email address here." : "You can set up an anti spam service address here.",
    "Any email that is marked as spam will be sent to the anti spam service." : "Any message that is marked as spam will be sent to the anti spam service.",
    ...
    "Anti Spam" : "Anti Spam",
    "Add the email address of your anti spam report service here." : "Add the address of your anti spam report service here.",
    ...
    "Reset" : "Reset",
    "Successfully set up anti spam email addresses" : "Successfully set up anti spam addresses",
    "Error saving anti spam email addresses" : "Error saving anti spam addresses",
    "Successfully deleted anti spam reporting email" : "Successfully deleted anti spam reporting address",
    "Error deleting anti spam reporting email" : "Error deleting anti spam reporting address",
    "Client ID" : "Client ID",
    ...
    "Email address template" : "Address template",
    "IMAP" : "IMAP",
    "User" : "User",
    "Host" : "Host",
    "Port" : "Port",
    ...
    "The LDAP aliases integration reads an attribute from the configured LDAP directory to provision email aliases." : "The LDAP aliases integration reads an attribute from the configured LDAP directory to provision aliases.",
    "LDAP attribute for aliases" : "LDAP attribute for aliases",
    "A multi value attribute to provision email aliases. For each value an alias is created. Aliases existing in Nextcloud which are not in the LDAP directory are deleted." : "A multi value attribute to provision aliases. For each value an alias is created. Aliases existing in the system which are not in the LDAP directory are deleted.",
    ...
    "E-mail address" : "Message address",
    ...
    "The private key is only required if you intend to send signed and encrypted emails using this certificate." : "The private key is only required if you intend to send signed and encrypted messages using this certificate.",
    "Submit" : "Submit",
    ...
    "recipientpersonmodalTitle" : "Person reference for recipient",
    "recipientreferencemodalTitle" : "Document reference for recipient",
    "senderpersonmodalTitle" : "Person reference for sender",
    "senderreferencemodalTitle" : "Document reference for sender",
    ...
    "You have a new secure message in ITSL Hubs" : "You have a new secure message in ITSL Hubs",
    ...
    "Could not create snooze mailbox" : "Could not create snooze folder",
    ...
    "Connect your mail account" : "Connect your mailbox",
    "To add a mail account, please contact your administrator." : "To get access to a mailbox, please contact your administrator.",
